    ...
    private String[][] allQuestionSets = {
        {
            ...
            "6. How much does the Lamborghini aventador cost?",
...
class TicTacToe extends JFrame implements ActionListener { //evan
    ...
    public TicTacToe(JFrame gameSelectionFrame) {
        ...
        JOptionPane.showMessageDialog(rulesPanel, "Grab an friend and PLAY! \n X : Player 1\nO : Player 2", getTitle(), JOptionPane.PLAIN_MESSAGE, new ImageIcon("Tic-tac-toe.png"));
